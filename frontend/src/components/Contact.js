          ...
          <div className="flex flex-col w-[80%] md:w-[40%] mx-auto">
            ...
            <div className="flex flex-row justify-center md:justify-start">
              <div className="mr-2 my-2">
                <a href="https://www.linkedin.com/in/khalid-meraj-777502260/" target='_blank'>
                  <FaLinkedin className="sm:text-1xl md:text-2xl lg:text-2xl" />
                </a>
              </div>
              <div className="mx-2 my-2">
                <a href="https://github.com/Khaliditsme/" target='_blank'>
                  <FaGithub className="sm:text-1xl md:text-2xl lg:text-2xl" />
                </a>
              </div>
              <div className="mx-2 my-2">
                <a href="mailto:khalidmeraj03@gmail.com?subject=Hello&body=Write%20your%20message%20here/" target='_blank'>
                  <FaEnvelope className="sm:text-1xl md:text-2xl lg:text-2xl" />
                </a>
              </div>
              <div className="mx-2 my-2">
                <a href="https://www.instagram.com/khalidmeraj27/?next=%2F&hl=en/" target='_blank'>
                  <FaInstagram className="sm:text-1xl md:text-2xl lg:text-2xl" />
                </a>
              </div>
              <div className="mx-2 my-2">
                <a href="https://www.youtube.com/channel/UCZqjFVQ1uw1QXPHMSfU5RBQ" target='_blank'>
                  <FaYoutube className="sm:text-1xl md:text-2xl lg:text-2xl" />
                </a>
              </div>
              <div className="mx-2 my-2">
                <a href="https://leetcode.com/u/khalidm32749/" target='_blank'>
            ...
            <form action="/contact" method="POST">
              ...
              <div className="flex flex-col justify-between items-center mt-[4vh]">
                ...
                <textarea
                  ...
                  required
                  autoComplete="off"
                  className="border-2 border-black w-[70%] h-[50%] rounded-md p-2"
