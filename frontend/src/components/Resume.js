  ...
  return (
    <div className='sm:m-5 md:m-6 lg:m-9'>
      ...
      <div className='flex flex-col md:flex-row lg:flex-row sm:justify-center sm:items-center md:justify-between md:items-start m-3 sm:m-2 md:m-0'>
        <h2 className='font-semibold text-2xl sm:text-2xl md:text-2xl lg:text-3xl text-center'>Education</h2>
        <div className='flex flex-col sm:w-[100%] md:w-[60%]'>
          ...
          <div className='flex flex-col md:flex-row lg:flex-row justify-start'>
            ...
            <div className='ml-5'>
              ...
              <p>Secondary Senior Education</p>
              <p>
      ...
      {/* Skills Section  */}
      <div className='flex flex-col md:flex-row lg:flex-row sm:justify-center sm:items-center md:justify-between md:items-start m-3 sm:m-2 md:m-0'>
        <h2 className='font-semibold  text-2xl sm:text-2xl md:text-3xl text-center'>Skills</h2>
      ...
      {/* Achievmnets Section */}
      <div className='flex flex-col md:flex-row lg:flex-row sm:justify-center sm:items-center md:justify-between md:items-start m-3 sm:m-2 md:m-0'>
        <h2 className='font-semibold text-2xl sm:text-2xl md:text-2xl lg:text-3xl text-center'> Achievments</h2>
      ...
      {/* Certifications  */}
      <div className='flex flex-col md:flex-row lg:flex-row sm:justify-center sm:items-center md:justify-between md:items-start m-3 sm:m-2 md:m-0'>
        <h2 className='font-semibold text-2xl sm:text-2xl md:text-2xl lg:text-3xl text-center'>Certifications</h2>
        <div className='sm:w-[100%] md:w-[60%]'>
          <ul>
            <li>
